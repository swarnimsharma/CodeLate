...
var User = {
    ...
    GetProfile: function (id) {
        ...
        $.ajax({
            ...
            asnc: false,
            success: function (data) {
                $('#candidate_pk_id').val(data.pk_user_id);
               // $('#user_pk_id').val(id),
                ...
                $('#candidate_fk_state_id').val(data.fk_state_id);
                $('#candidate_fk_city_id').val(data.fk_city_id);
                $('#candidate_fk_user_id').val(data.fk_user_type);
                $('#candidate_pk_id').val(data.pk_user_id);
